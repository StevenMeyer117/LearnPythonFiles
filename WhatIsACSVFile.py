...
# stands for Comma-Separated Values and CSV files are usually the way that data form spreadsheet software (like
...
# present in the rest of the file. The rest of the rows of the file are the same as teh rows in the spreadsheet
# software, just instead of being separated into different cells they're separated by... well I suppose it's fair to say
