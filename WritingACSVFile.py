...
# files that save output and data that someone could load into their spreadsheet software. Let's say we have a big list
# of data that we want to save into a CSV file. We could do the following:

# big_list = [{'name': 'Fredrick Stein', 'userid': 6712359021, 'is_admin': False}, {'name': 'Wiltmore Denis',
# 'userid': 2525942, 'is_admin': False}, {'name': 'Greely Plonk', 'userid': 15890235, 'is_admin': False}, {'name':
# 'Dendris Stulo', 'userid': 572189563, 'is_admin': True}]
#
# import csv
#
...
# 3. Create a csv.DictWriter instance called log_writer. Pass logger_csv as teh first argument and then fields as a
#    keyword fieldnames
